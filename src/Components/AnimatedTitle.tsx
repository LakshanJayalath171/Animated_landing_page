...
const AnimatedTitle = ({title,containeerClass,sectionId}) => {
  ...
  return (
    <div id={sectionId} className="mt-5 text-center text-4xl uppercase leading-[0.8] md;text-[6rem]" ref={containeerRef}>
